...
@section('title')
    <div class="page-header-title">
        <h4 class="m-b-10">{{ __('Companies') }}</h4>
    </div>
@endsection
@else
@section('title')
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="mt-4">
                                                <div class="row justify-content-between align-items-center">
                                                    ...
                                                    <div class="col-6 text-center Id ">
                                                        <a href="#" data-url="{{route('company.info', $user->id)}}" data-size="lg" data-ajax-popup="true" class="btn small--btn btn-outline-primary" data-title="{{__('Company Info')}}">{{__('AdminHub')}}</a>
                                                    </div>
                                                    <div class="col-12">
                                                        <hr class="my-3">
                                                    </div>
